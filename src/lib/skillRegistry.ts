    ...
    skills: [
        {
            ...
            description: "Auto-generate Conventional Commits messages from code diffs.",
            author: "sinaclaw",
            version: "1.0.0",
            icon: "wrench",
            tags: ["git", "dev-tools"],
        ...
        },
        {
            id: "web-search",
            name: "Web Search",
            description: "Search the internet via DuckDuckGo API and return result summaries.",
            author: "sinaclaw",
            version: "1.0.0",
            icon: "search",
            tags: ["search", "info"],
        ...
        },
        {
            ...
            description: "Professional lossless/lossy image compression using sharp/ffmpeg.",
            author: "sinaclaw",
            version: "1.0.0",
            icon: "image",
        ...
        },
        {
            ...
            description: "Convert Markdown files to beautifully typeset PDF documents via Pandoc.",
            author: "sinaclaw",
            version: "1.0.0",
            icon: "file",
        ...
        },
        {
            id: "code-reviewer",
            name: "Code Reviewer",
            description: "Static analysis on files with security, performance and readability suggestions.",
            author: "community",
            version: "0.9.0",
            icon: "microscope",
            tags: ["dev-tools", "code-quality"],
            downloads: 45,
