...
export const MODEL_OPTIONS: Record<AIProvider, { id: string; name: string; tag?: string }[]> = {
  openai: [
    { id: "gpt-5.2", name: "GPT-5.2", tag: "strongest" },
    { id: "gpt-5", name: "GPT-5" },
    { id: "gpt-5-mini", name: "GPT-5 mini", tag: "value" },
  ...
  anthropic: [
    { id: "claude-opus-4-6", name: "Claude Opus 4.6", tag: "strongest" },
  ...
  google: [
    { id: "gemini-3.1-pro", name: "Gemini 3.1 Pro", tag: "strongest" },
  ...
  deepseek: [
    { id: "deepseek-chat", name: "DeepSeek V3", tag: "general" },
    { id: "deepseek-reasoner", name: "DeepSeek R1", tag: "reasoning" },
  ],
  minimax: [
    { id: "MiniMax-M2.5", name: "MiniMax M2.5", tag: "strongest" },
    { id: "MiniMax-M2.5-highspeed", name: "MiniMax M2.5 Highspeed", tag: "fast" },
    { id: "MiniMax-M2.1", name: "MiniMax M2.1" },
    { id: "MiniMax-M2", name: "MiniMax M2" },
  ],
  zhipu: [
    { id: "glm-5", name: "GLM-5", tag: "strongest" },
