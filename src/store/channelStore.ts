...
export const CHANNEL_DEFINITIONS: ChannelDef[] = [
    {
        ...
        name: "WhatsApp",
        icon: "whatsapp",
        description: "通过 Baileys 连接 WhatsApp，扫码配对",
        requiredFields: [],
    ...
    },
    {
        ...
        name: "Telegram",
        icon: "telegram",
        description: "通过 grammY 连接 Telegram Bot",
        requiredFields: [
    ...
    },
    {
        ...
        name: "Slack",
        icon: "slack",
        description: "通过 Bolt SDK 连接 Slack 工作区",
        requiredFields: [
    ...
    },
    {
        ...
        name: "Discord",
        icon: "discord",
        description: "通过 discord.js 连接 Discord 服务器",
        requiredFields: [
    ...
    },
    {
        ...
        name: "Google Chat",
        icon: "googlechat",
        description: "通过 Google Chat API 连接",
        requiredFields: [
    ...
    },
    {
        ...
        name: "Signal",
        icon: "signal",
        description: "通过 signal-cli 连接 Signal",
        requiredFields: [
            { key: "phone", label: "手机号", type: "text", placeholder: "+86..." },
        ],
    ...
    },
    {
        ...
        icon: "imessage",
        description: "macOS 原生 iMessage 集成（仅 macOS）",
        requiredFields: [],
    ...
    },
    {
        ...
        icon: "msteams",
        description: "通过 Bot Framework 连接 Teams",
        requiredFields: [
    ...
    },
    {
        ...
        name: "Twitch",
        icon: "twitch",
        description: "连接 Twitch 聊天",
        requiredFields: [
            { key: "username", label: "用户名", type: "text" },
            { key: "token", label: "OAuth Token", type: "password" },
            { key: "channel", label: "频道", type: "text" },
        ],
    ...
    },
    {
        ...
        name: "WebChat",
        icon: "webchat",
        description: "内置 WebChat，使用 Gateway WebSocket",
        requiredFields: [],
