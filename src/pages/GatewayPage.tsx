...
import {
    Play, Square, RotateCcw, Activity, Server, Clock,
    Wifi, WifiOff, Terminal, Loader2,
} from "lucide-react";
import { useGatewayStore } from "@/store/gatewayStore";
import { useTranslate } from "@/lib/i18n";
import GatewayStatusBadge from "@/components/gateway/GatewayStatusBadge";
import GatewayInfoCard from "@/components/gateway/GatewayInfoCard";
import GatewayLogViewer from "@/components/gateway/GatewayLogViewer";
        ...
        >
            ...
            <div className="flex items-center justify-between">
                ...
                <div className="flex items-center gap-2">
                    <GatewayStatusBadge running={isRunning} loading={loading} />
            ...
            >
                <GatewayLogViewer logs={logs} onClear={clearLogs} />
            </motion.div>
